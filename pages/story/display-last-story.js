      ...
      {loading ? (
        ...
        <div className="flex flex-row justify-evenly mb-10 lg:flex-row items-center lg:items-center space-y-4 lg:space-y-0">
          ...
          >
            ...
            <button
              className={`whitespace-nowrap rounded mt-5 mb-5 inline-flex items-center px-10 h-10 gap-2 text-sm font-medium tracking-wide ${
                isFavourite ? "bg-emerald-500 text-white" : "text-emerald-500"
              } transition duration-300 hover:bg-emerald-300 hover:text-emerald-700 focus:bg-emerald-600 focus:text-orange focus-visible:outline-none disabled:cursor-not-allowed disabled:text-emerald-300 disabled:shadow-none disabled:hover:bg-transparent`}
